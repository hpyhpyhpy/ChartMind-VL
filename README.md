...
结论：1 epoch LoRA 在三项指标上均超过 Base，说明训练产生了有效学习信号。当前评估样本较少，不能作为最终效果结论，但已经完成了从训练到评估的可复现闭环。
